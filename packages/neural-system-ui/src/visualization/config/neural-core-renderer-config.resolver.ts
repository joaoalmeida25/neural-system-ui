...
import type { NeuralCoreClusterGrammarConfig as InternalClusterGrammarConfig } from "../cluster-grammar/neural-core-cluster-grammar.types";
import { resolveNeuralCoreClusterGrammarConfig } from "../cluster-grammar/neural-core-cluster-grammar.utils";
import type {
...
} from "../direction/neural-core-scene-direction.utils";
import type { NeuralCoreSemanticFocusLensConfig as InternalSemanticFocusLensConfig } from "../focus-lens/neural-core-semantic-focus-lens.types";
import { resolveNeuralCoreSemanticFocusLensConfig } from "../focus-lens/neural-core-semantic-focus-lens.utils";
import type { NeuralCoreClusterLabelConfig as InternalClusterLabelConfig } from "../labels/neural-core-cluster-label.types";
import { resolveNeuralCoreClusterLabelConfig } from "../labels/neural-core-cluster-label.utils";
import type { NeuralCoreLodConfig as InternalLodConfig } from "../lod/neural-core-lod.types";
import { resolveNeuralCoreLodConfig } from "../lod/neural-core-lod.utils";
import type { NeuralCoreSemanticVisualizationConfig as InternalSemanticConfig } from "../semantic/neural-core-semantic-visual.types";
import { resolveNeuralCoreSemanticVisualizationConfig } from "../semantic/neural-core-semantic-visual.utils";
import type { NeuralCoreSpatialLayoutConfig as InternalSpatialLayoutConfig } from "../spatial/neural-core-spatial-map.types";
import { resolveNeuralCoreSpatialLayoutConfig } from "../spatial/neural-core-spatial-map.utils";

export interface NeuralCoreRendererConfigInput {
  readonly inspection: {
  ...
  readonly visualization: {
    readonly density: "minimal" | "balanced" | "detailed";
